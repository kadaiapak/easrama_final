                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <div class="col-md-3 col-sm-3 profile_left">
                            ...
                            <br />
                            <a href="<?= base_url('admin/master-siswa'); ?>" class="btn btn-warning btn-sm"><i class="fa fa-chevron-circle-left" style="margin-right: 5px;"></i>Kembali</a>
                            <a href="<?= base_url('admin/siswa/edit/'.$detailSiswa['id']); ?>" class="btn btn-danger btn-sm"><i class="fa fa-edit" style="margin-right: 5px;"></i>Edit</a>
                        </div>
