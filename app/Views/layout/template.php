				...
				<div class="col-md-3 left_col">
					<div class="left_col scroll-view">
						<div class="navbar nav_title" style="border: 0; display: inline-block; display: flex; justify-content: center;">
							<img src="<?= base_url('logo_sekolah_alquran.png');?>" alt="logo" width="200" class="shadow-light mt-2" >
						</div>
						...
						<div class="sidebar-footer hidden-small">
							...
							<a href="<?= base_url('/logout'); ?>" data-toggle="tooltip" data-placement="top" title="Logout">
